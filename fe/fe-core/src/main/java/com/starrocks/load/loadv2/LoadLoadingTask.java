...
public class LoadLoadingTask extends LoadTask {
    ...
    public void init(TUniqueId loadId, List<List<TBrokerFileStatus>> fileStatusList, int fileNum) throws UserException {
        ...
        if (!Config.enable_insert_planner_v2) {
            ...
            insertPlanner = new InsertPlannerV2(callback.getCallbackId(), loadId, txnId, db.getId(), table, strictMode, 
    ...
    private void executeOnce() throws Exception {
        ...
        if (!Config.enable_insert_planner_v2) {
            ...
            curCoordinator = new Coordinator(insertPlanner);
        }
    ...
    public void updateRetryInfo() {
        ...
        if (!Config.enable_insert_planner_v2) {
            ...
            insertPlanner.updateLoadInfo(this.loadId);
        }
    }
}
